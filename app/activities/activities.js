...
.controller('ActivitiesController', function (Config, NavService) {
    ...
    var activityList = {
        ...
        codeLabs: {
            ...
            color: 'green',
            icon: 'images/icons/ic_code_48px.svg'
        },
        devFests: {
            name: 'Dev Fests',
            ...
            color: 'deepBlue',
            icon: 'images/icons/ic_event_48px.svg'
        },
        appClinics: {
            name: 'App Clinics',
            ...
            color: 'yellow',
            icon: 'images/icons/ic_local_hospital_48px.svg'
        },
        panels: {
            name: 'Panels',
            ...
            color: 'lightPurple',
            icon: 'images/icons/ic_people_48px.svg'
        },
        hackathons: {
            name: 'Hackathons',
            ...
            color: 'red',
            icon: 'images/icons/ic_timer_48px.svg'
        },
        designSprints: {
            name: 'Design Sprints',
            description: 'Intense, focused, collaborative brainstorming events where product design is key. ' +
                ...
                'and testing.',
            color: 'pink',
            icon: 'images/icons/ic_directions_run_48px.svg'
        }
    };
